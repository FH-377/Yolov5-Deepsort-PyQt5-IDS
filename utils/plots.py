...
def plot_one_box2(x, img, color=None, label=None, line_thickness=3, track_id=0):
    ...
    if label:
        ...
        if 'person' in label:
            cv2.putText(img, '{} ID-{}'.format(label, track_id), (c1[0], c1[1] - 2), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
        else:
