...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(817, 577)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../../../../87670/ui_img/icon.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.pushButton_init.setBaseSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        ...
        self.videoLinkInput = QtWidgets.QLineEdit(self.groupBox_2)
        self.videoLinkInput.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.videoLinkInput.sizePolicy().hasHeightForWidth())
        self.videoLinkInput.setSizePolicy(sizePolicy)
        self.videoLinkInput.setMinimumSize(QtCore.QSize(0, 0))
        self.videoLinkInput.setObjectName("videoLinkInput")
        self.verticalLayout.addWidget(self.videoLinkInput)
        ...
        self.intrusionRecord = QtWidgets.QTextBrowser(self.groupBox_2)
        self.intrusionRecord.setObjectName("intrusionRecord")
        self.verticalLayout_7.addWidget(self.intrusionRecord)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "yolov5s"))
        self.comboBox.setItemText(2, _translate("MainWindow", "yolov5m"))
        self.comboBox.setItemText(3, _translate("MainWindow", "yolov5+deepsort"))
        self.pushButton_init.setText(_translate("MainWindow", "初始化模型"))
        self.pushButton_video.setText(_translate("MainWindow", "视频检测"))
        self.videoLinkInput.setPlaceholderText(_translate("MainWindow", "摄像头地址，默认本机"))
        self.pushButton_camer.setText(_translate("MainWindow", "摄像头检测"))
        self.checkBox.setText(_translate("MainWindow", "区域入侵"))
        self.pushButton.setText(_translate("MainWindow", "绘制区域"))
        self.pushButton_2.setText(_translate("MainWindow", "上传区域"))
